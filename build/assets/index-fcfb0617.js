...
`,it=a=>Oa.filter(r=>r.hero_name===a)[0]||{},Be=({heroName:a,skills:t})=>e.createElement(st,null,e.createElement(De,{heroName:a,upgrades:it(a),skills:t}),e.createElement(nt,{"data-for":"aghanim","data-tip":"aghanim"},e.createElement(ke,{src:"/assets/images/dota2/scepter_0.png",alt:"Aghanim's scepter"}),e.createElement(ke,{src:"/assets/images/dota2/shard_0.png",alt:"Aghanim's shard"})));Be.propTypes={heroName:m.string,skills:m.shape({})};const Y=(await ve(()=>import("./abilities-96b9b6e2.js"),[])).default,ot=(await ve(()=>import("./index-63950985.js").then(a=>a.aA),[])).default,lt=_.div`
  align-items: center;
  display: flex;
  justify-content: center;
  margin-left: -4px;
